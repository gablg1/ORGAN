...
class ROLLOUT(object):
    def __init__(self, lstm, update_rate):
        ...
        self.latent = tf.placeholder(tf.float32, [self.batch_size, self.lstm.latent_dim])
        ...
        i, x_t, h_tm1, given_num, self.gen_x = control_flow_ops.while_loop(
            ...
            loop_vars=(tf.constant(0, dtype=tf.int32),
                       start_emb, self.h0, self.given_num, gen_x))
    ...
    def get_reward(self, sess, input_x, rollout_num, cnn):
        ...
        for i in range(rollout_num):
            for given_num in range(1, self.sequence_length):
                feed = {self.x: input_x, self.given_num: given_num, self.latent: np.random.normal(size=(self.batch_size,
                    self.lstm.latent_dim))}
